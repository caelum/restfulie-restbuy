...
class SystemController < ApplicationController
  ...
  def search
    render :content_type => "application/opensearchdescription+xml", :text => Searchie::OpenSearch.new.accepts("application/xml").at(products_url + "?q={searchTerms}&amp;pw={startPage?}&amp;format=xml").to_xml
  end
